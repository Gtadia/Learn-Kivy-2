...
class MyGridLayout(GridLayout):
    ...
    def __init__(self, **kwargs): 
        ...
        )       # "row_force_default" and "col_force_default sets the default row and column sizes to a new default
        ...
        self.top_grid.add_widget(Label(text="Favorite Pizza: "))    # Because the label is still normal size, the columns is going to maintain its size because of it
